...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('application', '0059_delete_vs_vehicles'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trailer_hitch', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', max_length=10)),
                ('navigation', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', max_length=10)),
                ('air_conditioning', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], default='No', max_length=10)),
